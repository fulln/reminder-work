export const chineseCapabilityContent = {
  online: {
    ...
    title: "在线提醒工具——免费、快速、无需注册 | Reminders.work",
    description:
  ...
  email: {
    ...
    title: "邮箱提醒——验证后安全发送 | Reminders.work",
  ...
  recurring: {
    ...
    title: "周期提醒——每日、每周或每月 | Reminders.work",
  ...
  meeting: {
    ...
    title: "会议提醒——提前通知与准确时区 | Reminders.work",
  ...
  deadline: {
    ...
    title: "截止日期提醒——支持多个提前通知 | Reminders.work",
  ...
  "follow-up": {
    ...
    title: "跟进提醒——完成、稍后提醒与改期 | Reminders.work",
